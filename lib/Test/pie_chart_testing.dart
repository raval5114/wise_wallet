...
import 'package:wise_wallet/Test/pieChartModel.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          WiseWalletPieChart(
              chartType: "Income", chartData: data, amount: 150000),
          SizedBox(
            height: 10,
          ),
  ...
  Widget build(BuildContext context) {
    ...
    final List<PieChartSectionData> pieChartData = widget.chartData.map((e) {
      return PieChartSectionData(
        color: e['color'],
        value: e['percentage'],
        title: '', // Keep the sections clean (optional)
        radius: 12, // Set the thickness of each section
